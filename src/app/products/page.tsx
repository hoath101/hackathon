          ...
          data.map((data, index) => {
            return (
              <Link key={index} href={"/product"}>
                <div className='p-2 shadow-lg  hover:scale-105 active:scale-100 transition '>
                  <Image src={data.imageUrl} alt={data.name} height={300} width={200}
                  className="w-[275px] h-[325px] "></Image>
                  <div>
