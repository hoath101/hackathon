...
const Footer = () => {
    return (
        <main>
            ...
            <div className='block lg:hidden max-w-max overflow-hidden'>
                <div className=' bg-[#2A254B] text-white text-sm mt-6'>
                    <div className='flex justify-around gap-6'>
                        <div className='mt-10 mb-20'>
                            <ul>Menu</ul>
                            <ul className='mt-3'>New arrivals</ul>
                    ...
                    <div className='mt-10 ml-10'>
                        <p>Join our mailing list</p>
                        <div className='flex'>
                            <div className='w-[224px] h-[56px] bg-[#4E4D93] mt-4'>
                                <input type="email" placeholder='your@email.com'
                                    className='w-[117px] h-[22px] ml-10 mt-4 bg-[#4E4D93]' />
                            </div>
                            <div>
                    ...
                    <hr className='w-[1277] ml-10 fill-[#4E4D93] mt-4' />
                    <div className='flex justify-center text-center mt-4 '>
                        <p className='text-white mb-2'>Copyright 2022 Avion LTD</p>
                    </div>
                </div>
            </div>
        </main>
